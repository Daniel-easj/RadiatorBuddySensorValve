...
while True:
    ...
    suggested_new_temperature = suggested_new_temperature(one_day_forecast_list, pidata_list_one_day_old, global_optimal_temperature,
                                                          minimum_room_temperature, maximum_room_temperature, 3, 23)
    if suggested_new_temperature < 1:
